...
module.exports = function () {
    const config = {
        ...
        output: {
            ...
            publicPath: '/',
            filename: isBuild ? 'static/[name].[hash:8].js' : 'static/[name].bundle.js',
            chunkFilename: isBuild ? 'static/[name].[hash:8].js' : 'static/[name].bundle.js'
        },
        externals: {
            jQuery: 'window.$'
        },
        module: {
            ...
            },
            {
                ...
                loader: 'url?limit=8192?file&name=static/images/[hash].[ext]'
            }
        ...
        plugins: [
            ...
            new webpack.optimize.CommonsChunkPlugin('vendor', isBuild ? 'static/vendor.js' : 'static/vendor.bundle.js'),
            ...
            new ExtractTextPlugin(isBuild ? 'static/[name].[hash:8].css' : 'static/[name].css')
